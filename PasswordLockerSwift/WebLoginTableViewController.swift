//
//  WebLoginTableViewController.swift
//  PasswordLockerSwift
//
...
class WebLoginTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        self.performSegueWithIdentifier("toEditWebLoginSegue", sender: indexPath)
    }
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "toEditWebLoginSegue" {
    ...
    func getPlaceholder(indexPath: NSIndexPath) -> String {
        ...
        case 1:
            ...
            else if indexPath.row == 1 { return "Password" }
            else { return "Url" }
        default:
            return "Notes"
        }
