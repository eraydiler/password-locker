...
class EmailTypeTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        self.performSegueWithIdentifier("toEmailTVCSegue", sender: indexPath)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "toEmailTVCSegue" {
            let targetVC = segue.destinationViewController as EmailTableViewController
