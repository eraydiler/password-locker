...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let isAppInitializedWithData = UserDefaults.standard
                                           .bool(forKey: kPasswordLockerUserDefaultsHasInitialized)
        ...
        if (isAppInitializedWithData == false) {
            ...
            UserDefaults.standard
                .set(true, forKey: kPasswordLockerUserDefaultsHasInitialized)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "PasswordLockerSwift", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("PasswordLockerSwift.sqlite")
...
//            error1 = NSError(domain: "YOUR_ERROR_DOMAIN", code: 9999, userInfo: dict as [AnyHashable: Any]!)
